    ...
    init: function() {
        $('#cal-basic').fullCalendar45({
            ...
            select: function(start, end, allDay) {
                ...
                if (title) {
                    $('#cal-basic').fullCalendar45('renderEvent',
                    {
                        title: title,
                        start: start._d,
                        end: end._d,
                ...
                $('#cal-basic').fullCalendar45('unselect');
            },
            events: [
            {
                title: 'All Day Event',
            ...
            select: function(start, end, allDay) {
                var title = prompt('Event Title:');
                if (title) {
                    $('#cal-basic-view').fullCalendar45('renderEvent',
                    {
                        title: title,
                        start: start._d,
                        end: end._d,
                ...
                $('#cal-basic-view').fullCalendar45('unselect');
            },
            events: [
            {
                title: 'All Day Event',
        ...
        }), $('#cal-agenda-view').fullCalendar45({
            header: {
